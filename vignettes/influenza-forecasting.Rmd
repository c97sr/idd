...
Q: How many weekly incidence reports do you have in your dataset?

Q: What month(s) and years(s) does the dataset contain?

Q: What differences do you see across the years?
...
The duration of the epidemic is the time between the last week the incidence exceeds the threshold, and the first week during which the incidence exceeds the threshold (the onset time).

Q: for each year (2010-2016), by visual inspection of the plot, identify the onset time, peak time, peak incidence and duration of the epidemic.  
...
Q: What do you think the black, red and blue points represent on this chart?
...
Q: Where, if anywhere, do you think the model gives a good prediction?  In qualitative terms, does accuracy change over time? If so, how?
...
For week 49, what was your best forecast?  For how many weeks is it accurate?
